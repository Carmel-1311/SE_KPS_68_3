...
import { getRoleLabel } from '@/hook/usePersonnelWorkSchedulePage';
...
export default function DentistEditWorkSchedulePage() {
  ...
  const handleDelete = async () => {
    try {
      ...
      message.success('ลบตารางการทำงานเรียบร้อยแล้ว');
      router.push('/dentist/work-schedule');
    } catch (error) {
