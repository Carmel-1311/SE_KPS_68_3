        ...
        {selectedAppointment && (
          <div style={{ marginTop: '16px' }}>
            <Descriptions bordered column={2} size="small" styles={{ label: { background: '#fafafa', fontWeight: 'bold' } }}>
              ...
              <Descriptions.Item label="ชื่อ-นามสกุล" span={1}><Text strong>{selectedAppointment.patient.name}</Text></Descriptions.Item>
              <Descriptions.Item label="ทันตแพทย์" span={1}>{selectedAppointment.staff.name}</Descriptions.Item>
