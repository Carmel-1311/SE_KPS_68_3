...
import {
  SearchOutlined, PlusOutlined, ReadOutlined,
...
export default function AppointmentListPage() {
  ...
  const finalFilteredData = data.filter((item) => {
    ...
    const matchName = item.patient.name
      .toLowerCase()
  ...
  const columns: ColumnsType<Appointment> = [
    {
      title: 'ลำดับ', key: 'index', width: 70, align: 'center',
      render: (_, __, index) => <Text strong>{index + 1}</Text>,
    },
    {
      title: 'วันและเวลา', key: 'datetime',
      render: (_, record) => (
    ...
    {
      title: 'ชื่อคนไข้', key: 'patient_name',
    ...
    {
      title: 'ทันตแพทย์', key: 'staff_name',
